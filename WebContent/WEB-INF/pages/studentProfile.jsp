                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p>${student.book1}  </p>    <div class="row1"><form action="returnBook">

<input name="book1" type="hidden" value="${student.book1}">

<button type="submit" class="input-field1">hello book</button>  
  </form>
  </div>
                                         ...
                                         <div class="row">
                                          ...
                                          <div class="col-md-6">
                                                <p> ${student.book2}</p>
                                                 <div class="row1"><form action="returnBook">
                                        <input name="book2" type="hidden" value="${student.book2}">
                                        <button class="input-field1" type="submit">return</button>
                                                  </form></div>
                                            </div>
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p>${student.book3}</p><div class="row1"><form action="returnBook">
<input name="book3" type="hidden" value="${student.book3}">
<button type="submit" class="input-field1">return</button>
  </form></div>
                                            </div>

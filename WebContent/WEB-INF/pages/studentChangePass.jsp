...
<div class="split left">
  <div class="centered">
    <h2 >Please Enter Your Old and New password here:!</h2>
    <form action="studentChangePassword" onSubmit=" return checking()"  method="post" >
      <div class="container">
    <input type="text" placeholder="old password" name="password"><br>
